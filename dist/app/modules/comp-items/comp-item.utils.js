...
exports.compItemExcludeFilteringFields = exports.pagination = void 0;
...
// export const CompItemSearchableFields = ['title', 'prefix', 'code'];
exports.compItemExcludeFilteringFields = [
    'page',
    'limit',
    'sortBy',
    'sortOrder',
